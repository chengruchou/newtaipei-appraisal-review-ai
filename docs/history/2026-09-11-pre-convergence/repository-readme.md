...
Current integration: [#21 extraction/evaluation](../../issue-21-delivery.md) is
followed by [#30 durable Runtime delivery](../../issue-30-delivery.md). Both remain
Draft pending their named dependency and live gates. [Runtime operations](../../runtime-deployment.md)
cover local ARM64 packaging and the guarded deployment procedure. [#31](../../issue-31-delivery.md) adds strict evidence validation, real localhost
...
merged. [Project progress](../../project-progress.md) distinguishes this baseline,
...
The [Phase 7 handoff](../../issue17-service-handoff.md) maps authenticated task APIs
...
[workbench consumer fixtures](../../workbench-consumer-handoff.md), and a reproducible
[offline evaluation harness](../../offline-evaluation.md). Phase 8 production
...
[M0 pre-submission review](../../m0-review.md) records reproduced defects, fixes
and preserved trust boundaries. [Traceability](../../delivery-traceability.md) separates local tests, historical CI
...
follow the [local service runbook](../../local-service-runbook.md). No writer/font
...
The [shared service contract](../../service-contracts.md),
...
The [local human-review guide](../../local-human-review.md) describes explicit task
...
See [current and target architecture](../../architecture.md),
[A–E ownership and M0–M3](../../mvp-plan.md), [PDF contract](../../pdf-contract.md),
[document preparation](../../member-a-runbook.md), [cloud smoke](../../../cloud_tests/README.md)
and [competition requirements](../../competition-requirements.md).
The [document transfer contract](../../document-transfer.md) and
