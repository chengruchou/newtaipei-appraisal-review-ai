# Historical snapshot: delivery-traceability.md
...
HTTP/job/browser work. Read [ADR 0028](../../adr/0028-controlled-execution-failure-boundaries.md)
...
Phase 1 adds ADR 0018 and exact `WorkflowSnapshot`, `AllowedActionSet`, typed action
