...
| [#47](https://github.com/chengruchou/newtaipei-appraisal-review-ai/issues/47) | Connect fresh routing discovery to each requested model's exact approved destination set | Offline code fix now; prerequisite for competition model invocation |
